...
import bannerdrinks from "./assets/Dark Brown Coffee Shop Special Promo Banner.png";
import bannerfoods from "./assets/Dark Brown Coffee Shop Special Promo Banner.png";
