      ...
      <div className="flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="box-border bg-white w-full rounded-sm mt-4 flex-grow">
          <div className="box-border bg-white rounded-md w-full">
            <h4 className="bold-22 p-5 uppercase">Menu Items</h4>
                  ...
                  {allProducts.map((product, i) => (
                    ...
                    >
                      ...
                      <td>
                        ...
                        >
                          <div className="bg-green-900 hover:bg-green-600 text-white font-bold py-2 px-4 rounded flex items-center cursor-pointer"
                          style={{ width: "100px" }}
                          >
                      ...
                      <td>
                        <div
                          className="bg-red-600 hover:bg-red-400 text-white font-bold py-2 px-4 rounded flex items-center cursor-pointer"
                          style={{ width: "100px" }}
